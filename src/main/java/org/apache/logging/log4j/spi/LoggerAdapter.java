 ...
 * Logger classes. This registry should not be used for Log4j Loggers; it is instead
 * used for creating bridges to other external log systems.
 *
...
public interface LoggerAdapter<L> extends Closeable {
     ...
     * Overridden from Closeable to not throw IOException.
     */
    @Override
    void close();
}
